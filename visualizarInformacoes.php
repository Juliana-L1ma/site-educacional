      ...
      <div class="tabelaAtt">
        <table id="tabelaAtt">
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sqlCursoCai = "SELECT nome_curso, categoria, capacidade, carga_horaria_curso, valor_curso, plano_curso
          FROM cursos
          WHERE categoria = 'CAI'";
            $sqlCursoFic = "SELECT nome_curso, categoria, capacidade, carga_horaria_curso, valor_curso, plano_curso
          FROM cursos
          WHERE categoria = 'FIC'";
            $sqlCursoTecnico = "SELECT nome_curso, categoria, capacidade, carga_horaria_curso, valor_curso, plano_curso
          FROM cursos
          ...
          WHERE cursos.nome_curso = '$nome_curso'";
            ...
            unidades_curriculares.carga_horariaUc,
            unidades_curriculares.area_vinculadaUc
            FROM
            lista_curso_uc
            JOIN cursos ON lista_curso_uc.id_curso = cursos.id_curso 
            JOIN unidades_curriculares ON lista_curso_uc.id_unidade_curricular = unidades_curriculares.id_unid_curricular
            ...
            <h2>$nome_curso</h2>
              ...
              if ($results->num_rows > 0) {
                while ($row = $results->fetch_assoc()) {
                  ...
                  echo "<td>" . $row["carga_horariaUc"] . "</td>";
                  echo "<td>" . $row["area_vinculadaUc"] . "</td>";
                }
              }
            }
